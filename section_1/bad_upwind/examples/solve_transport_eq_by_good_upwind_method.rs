...
fn main() {
    ...
    let mut inputfile = File::open(
        "inputs/section_1/bad_upwind/solve_transport_eq_by_good_upwind_method/input.yml",
    )
    .unwrap_or_else(|err| {
    ...
    // setup output files
    let dir_str = "outputs/section_1/bad_upwind/solve_transport_eq_by_good_upwind_method";
