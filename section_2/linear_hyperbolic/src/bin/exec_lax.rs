...
fn main() {
    ...
    let mut inputfile = File::open("inputs/section_2/linear_hyperbolic/exec_lax.yml")
        .unwrap_or_else(|err| {
    ...
    let mut outputfile = File::create(format!("{}/exec_lax.dat", dir_str)).unwrap_or_else(|err| {
